...
import com.example.testing.databinding.LayoutAudioTrimmerBinding
import com.example.testing.slidingwindow.SlidingWindowView
...
class AudioTrimmerView @JvmOverloads constructor(
    ...
    @ColorInt
    private var borderColor: Int = context.getColor(R.color.white)
    @ColorInt
